...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour must have a name with less than or equal to 40 characters'],
      minlength: [10, 'A tour must have a name with less than or equal to 10 characters'],
    ...
    ratingsAverage: {
      ...
      max: [5, 'A tour can only have a maximum rating of 5'],
...
// parent referencing through virtual populate
